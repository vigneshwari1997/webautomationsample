...
describe('Casting Director should be able to assign compensation to talent', () => {
    it('#smoke:cd able to add talent with compensations', () => {
        loginpage.login(data.env.DEV.URL,data.env.DEV.CDusername,data.env.DEV.CDpassword);
        skinuploadpage.createshoot();
...
describe('Casting director trying to view and edit details', () => {

    it('#smoke:cd able to see view and edit until checkout', () => {
        loginpage.login(data.env.DEV.URL,data.env.DEV.CDusername,data.env.DEV.CDpassword);
...
describe('Casting Director should abe to delete the talents', () => {
